    ...
    <AppLayout>
        ...
        <v-data-table :headers="headersSerie" :items="series">
                ...
                <v-toolbar flat>
                    ...
                    <v-dialog v-model="dialogFormSerie" max-width="800px">
                        ...
                        <v-card>
                            ...
                            <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn color="blue-darken-1" variant="text" @click="closeFormSerie">
                                    cancelar
                                </v-btn>
                                <v-btn color="blue-darken-1" variant="text" @click="saveDataSerie">
                                    guardar
                                </v-btn>
                            </v-card-actions>
                        </v-card>
                    ...
                    <v-dialog v-model="dialogDeleteSerie" max-width="500px">
                        <v-card>
                            <v-card-title class="text-h5">¿esta seguro de eliminar esta serie?</v-card-title>
                            <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn color="blue-darken-1" variant="text" @click="closeDeleteConfirmationSerie">cancelar</v-btn>
                                <v-btn color="blue-darken-1" variant="text"
                                    @click="deleteSerieConfirmation">eliminar</v-btn>
                                <v-spacer></v-spacer>
                            </v-card-actions>
                        </v-card>
                    </v-dialog>
            ...
            <template v-slot:item.actions="{ item }">
                <v-icon class="me-2" size="small" @click="editSerie(item)">
                    mdi-pencil
                </v-icon>
                <v-icon size="small" @click="deleteSerie(item)">
                    mdi-delete
                </v-icon>
            </template>
        </v-data-table>
