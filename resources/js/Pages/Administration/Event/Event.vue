                ...
                <v-tabs-window-item v-for="event_for_type in events_for_type" :key="event_for_type.event_type_id" :value="event_for_type.event_type_id">
                    <v-data-table :headers="headersEvent" :items="event_for_type.events">
                            ...
                            <v-toolbar flat>
                                ...
                                <v-dialog v-model="dialogFormEvent" max-width="800px">
                                    ...
                                    <v-card>
                                        ...
                                        <v-card-actions>
                                            <v-spacer></v-spacer>
                                            <v-btn color="blue-darken-1" variant="text" @click="closeFormEvent">
                                                cancelar
                                            </v-btn>
                                            <v-btn color="blue-darken-1" variant="text" @click="saveDataEvent">
                                                guardar
                                            </v-btn>
                                        </v-card-actions>
                                    </v-card>
                                ...
                                <v-dialog v-model="dialogDeleteEvent" max-width="500px">
                                    <v-card>
                                        <v-card-title class="text-h5">¿esta seguro de eliminar el evento?</v-card-title>
                                        <v-card-actions>
                                            <v-spacer></v-spacer>
                                            <v-btn color="blue-darken-1" variant="text"
                                                @click="closeDeleteConfirmationEvent">cancelar</v-btn>
                                            <v-btn color="blue-darken-1" variant="text"
                                                @click="deleteEventConfirmation">eliminar</v-btn>
                                            <v-spacer></v-spacer>
                                        </v-card-actions>
                                    </v-card>
                                </v-dialog>
                        ...
                        <template v-slot:item.actions="{ item }">
                            ...
                            <v-icon size="small" @click="deleteEvent(item)">
                                mdi-delete
                            </v-icon>
                        </template>
                    </v-data-table>
