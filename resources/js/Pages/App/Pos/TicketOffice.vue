...
<template>
    ...
    <main class="tw-relative tw-overflow-hidden">
            ...
            <SuccessSession />
                <div class="tw-w-full tw-flex tw-gap-10 lg:tw-gap-20 tw-flex-col lg:tw-flex-row">
                    ...
                    <div class="tw-space-y-5 lg:tw-space-y-8 tw-w-full lg:tw-w-[60%]">
                        ...
                        <h2 class="lg:tw-text-4xl tw-text-3xl tw-font-bold">{{ formatFirstLetterUppercase(ticket_office.name )}}. Administracion para el club halcones de xalapa</h2>
                        <div class="tw-py-2 tw-px-5 tw-border-l-4 tw-border-l-purple-500 tw-w-full tw-bg-purple-200 tw-text-purple-600">
                            {{ formatFirstLetterUppercase(ticket_office.description) }}
                        </div>
        ...
        <div class="tw-w-full tw-bg-slate-950 tw-relative tw-overflow-hidden tw-mt-16 tw-mb-36">
            <div class="tw-max-w-7xl tw-mx-auto tw-flex tw-flex-wrap tw-items-center tw-justify-center lg:tw-justify-between tw-py-10 tw-gap-14 tw-px-4 lg:tw-px-0">

                <div class="tw-flex-1 tw-min-w-[250px] tw-max-w-[350px] tw-bg-white/10 tw-rounded-lg tw-flex tw-items-center tw-justify-center tw-gap-5 tw-mx-4 tw-flex-col hover:tw-scale-105 tw-transition-all tw-duration-500 tw-z-20 tw-text-center">
                    <h3 class="text-white tw-text-2xl">Abrir caja</h3>
                    <div class="text-center pa-4">
                        <v-dialog max-width="700">
                            <template v-slot:activator="{ props: activatorProps }">
                                <v-btn v-bind="activatorProps" variant="elevated" class="text-none !tw-text-white !tw-bg-gradient-to-r !tw-from-purple-600 !tw-to-pink-400 !tw-h-20 !tw-w-[335px]" rounded="xl" size="large" block><span class="material-symbols-outlined tw-text-xl !tw-w-1/2">store</span>Abrir caja registradora</v-btn>
                            </template>
                            <template v-slot:default="{ isActive }">
                ...
                <div class="tw-flex-1 tw-min-w-[250px] tw-max-w-[350px] tw-bg-white/10 tw-rounded-lg tw-flex tw-items-center tw-justify-center tw-gap-5 tw-mx-4 tw-flex-col hover:tw-scale-105 tw-transition-all tw-duration-500 tw-z-20 tw-text-center tw-relative">
                    <div v-if="active_cash_register" class="tw-absolute -tw-top-1 -tw-right-1">
                        ...
                        <div class="text-center pa-4">
                            ...
                            >
                                <template v-slot:activator="{ props: activatorProps }">
                                <v-btn v-bind="activatorProps" variant="elevated" class="text-none !tw-text-white !tw-bg-gradient-to-r !tw-from-purple-600 !tw-to-pink-400 !tw-h-20 !tw-w-[335px]" rounded="xl" size="large" block><span class="material-symbols-outlined tw-text-xl !tw-w-1/2">credit_score</span>Caja aperturada</v-btn>
                                </template>
